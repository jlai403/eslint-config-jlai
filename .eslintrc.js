  ...
  'plugins': [
	...
	'overrides': [{
		...
		'rules': {
			...
			'@typescript-eslint/no-type-alias': ['error', {'allowAliases': 'in-unions', 'allowCallbacks': 'never', 'allowConditionalTypes': 'never', 'allowConstructors': 'never', 'allowLiterals': 'never', 'allowMappedTypes': 'never', 'allowTupleTypes': 'always', 'allowGenerics': 'always'}],
