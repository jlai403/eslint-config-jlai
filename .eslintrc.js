  ...
  'plugins': [
	...
	'overrides': [{
		...
		'rules': {
			...
			'@typescript-eslint/no-unused-vars': ['error', {'vars': 'all', 'varsIgnorePattern': '^_', 'args': 'none', 'ignoreRestSiblings': false, 'argsIgnorePattern': '', 'caughtErrors': 'all', 'caughtErrorsIgnorePattern': '', 'destructuredArrayIgnorePattern': ''}],
